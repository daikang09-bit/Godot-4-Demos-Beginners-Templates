...
<img width="630" height="500" alt="Image_10" src="https://github.com/user-attachments/assets/84bb9686-b76e-4900-b881-2344aac8b40f" />
...
4. Click 'Import', then navigate to the extracted folder and 
   select 'project.godot'.

-----------------------------------------------------------
3. LICENSE (Simple Terms)
-----------------------------------------------------------
...
4. FEEDBACK & SUPPORT
-----------------------------------------------------------
Found a bug or have a suggestion? Leave a comment on the 
